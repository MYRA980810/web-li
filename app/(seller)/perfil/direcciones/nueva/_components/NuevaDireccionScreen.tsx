...
export type NuevaDireccionScreenProps = {
  isFirstAddress: boolean
}

export function NuevaDireccionScreen({ isFirstAddress }: NuevaDireccionScreenProps) {
    ...
    <>
      ...
      <div className="stage screen-enter">
        ...
        <div className="px-5 pt-6 pb-10 max-w-md mx-auto w-full reveal d1">
          <DireccionStep mode="create" isFirstAddress={isFirstAddress} onNext={() => router.push('/perfil/direcciones')} />
        </div>
      </div>
    </>
  )
